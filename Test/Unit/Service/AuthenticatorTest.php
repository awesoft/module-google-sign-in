...
class AuthenticatorTest extends TestCase
{
     ...
     * @param int $error
     * @param int $proceed
     * @param int $canBypassTfa
     * @param bool $bypassTfa
    ...
    {
        return [
            [[null, 9, 9], true, 1, 1, 0, 1, true, 1],
            [[9, 9], true, 0, 0, 0, 1, true, 1],
            [[9, 9], true, 0, 0, 0, 1, false, 0],
            [[9, 9], false, 0, 0, 0, 1, true, 1],
        ];
    }
